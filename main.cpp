...
uint16_t irTVvdn[] = {2460, 545, 1286, 518, 1286, 519, 684, 519, 686, 519,
                         1286, 519, 685, 519, 687, 516, 1259, 545, 684, 519,
                        684, 520, 672, 520, 680};

  // Insert RAW IR signal for
uint16_t irRECvup[] = {2514, 489, 1315, 489, 714, 481, 1324, 489, 715, 489,
                       1315, 489, 714, 489, 714, 490, 1315, 489, 715, 489,
                        714, 490, 713, 490, 701};
